...
export function UserBenefits() {
  const userTypes = [
    ...
    },
    {
      ...
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/for-companies-Z7W86MILsz1k30EDLHjby4eHoQHiwM.png",
    ...
    },
    {
      ...
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/for-farms-U48eaLY359I3wNRCPEzPEIiSGJimCW.png",
      id: "benefits-farms",
          ...
          <AnimatedSection animation="fade-up">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Personalized solutions for every need in the TreeByte ecosystem
              </p>
            </div>
          </AnimatedSection>
            ...
            <div className="text-center mt-20">
              <div className="bg-white rounded-2xl p-12 shadow-lg border border-gray-100">
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                  Join thousands of individuals, companies, and farms already
                  making a positive environmental impact through TreeByte.
                </p>

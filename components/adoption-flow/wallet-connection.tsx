              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Latest generation blockchain technology
                    </p>
                  </div>
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Instant and economical transactions
                    </p>
                  </div>
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Each NFT is backed by a real tree
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-700">
                    Stellar is a fast and low-cost blockchain network, perfect
                    for environmental impact projects like TreeByte. Its focus
                    on financial inclusion and sustainability makes it ideal for
                    global tree adoption initiatives.
                  </p>
                </div>
                ...
                <p className="text-xs text-gray-500 text-center">
                  By connecting your wallet, you accept our terms of service and
                  privacy policy.
                </p>
              </>
            ) : (

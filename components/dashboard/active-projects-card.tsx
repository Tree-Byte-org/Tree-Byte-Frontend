...
export default function ActiveProjectsCard() {
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex gap-4 h-fit">
      ...
      <div className="flex flex-col justify-start">
        ...
        <p className="text-sm text-gray-600 leading-relaxed mt-1 max-w-xs">
